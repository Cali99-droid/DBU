...
<div class="barra">
	...
	<div class="barra__opciones">
			...
			<a class="opcion"  href="psicologia">
				<svg  class="opcion__log" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20.787,9.023c-0.125,0.027-1.803,0.418-3.953,1.774c-0.323-1.567-1.279-4.501-4.108-7.485L12,2.546l-0.726,0.767 c-2.839,2.995-3.791,5.937-4.111,7.514C5.005,9.448,3.34,9.052,3.218,9.024L2,8.752V10c0,7.29,3.925,12,10,12 c5.981,0,10-4.822,10-12V8.758L20.787,9.023z M8.999,12.038C9.001,12.005,9.151,8.938,12,5.506C14.814,8.906,14.999,12,15,12 v0.125c-0.998,0.826-2.029,1.861-3.01,3.154c-0.984-1.271-2.007-2.293-2.991-3.113V12.038z M12,20 c-5.316,0-7.549-4.196-7.937-8.564c1.655,0.718,4.616,2.426,7.107,6.123l0.841,1.249l0.825-1.26 c2.426-3.708,5.425-5.411,7.096-6.122C19.534,15.654,17.304,20,12,20z"></path></svg>
				Psicología
			</a>
			<a class="opcion"  href="#">
				<svg  class="opcion__log"  xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M20.937,7.53C19.227,4.119,15.803,2,12,2C6.486,2,2,6.486,2,12s4.486,10,10,10c3.803,0,7.227-2.119,8.937-5.53 c0.238-0.475,0.063-1.053-0.397-1.316L15.017,12l5.522-3.153C21,8.583,21.175,8.005,20.937,7.53z M12.504,11.132 C12.192,11.31,12,11.641,12,12s0.192,0.69,0.504,0.868l6.173,3.525C17.205,18.639,14.724,20,12,20c-4.411,0-8-3.589-8-8 s3.589-8,8-8c2.724,0,5.205,1.361,6.677,3.606L12.504,11.132z">     
				</path><circle cx="11.5" cy="7.5" r="1.5"></circle></svg>
				Odontología
			</a>
