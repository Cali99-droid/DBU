...
if( $_POST['r'] == 'paciente-add' && $_SESSION['ROL'] == 'Administrador'  && !isset($_POST['crud']) ) {
...
$escuelas = $topico->getEscuelas();
...
} else if( $_POST['r'] == 'paciente-add' && $_SESSION['ROL'] == 'Administrador'  && $_POST['crud'] == 'set' ) {
	...
	$pas = $pas_controller->set($new_pas);
